'use client';
import { Container, Title, Text, Image, SimpleGrid, Card, Badge, Stack, Divider } from '@mantine/core';
    ...
    return (
        <Container size="xs" py="xl">
            <Stack gap="md">
                ...
                <Stack gap={2}>
                    <Title order={1} c="green.9">{plant.common_name}</Title>
                    {plant.scientific_name && (
                        <Text c="dimmed" fz="sm" fs="italic">{plant.scientific_name}</Text>
                    )}
                </Stack>
                ...
                <SimpleGrid cols={2}>
                    <Card withBorder radius="md">
                        <Text fw={700} size="xs" c="blue" tt="uppercase">💧 Riego</Text>
                        <Text size="md">{plant.requirements.water}</Text>
                    </Card>

                    <Card withBorder radius="md">
                        <Text fw={700} size="xs" c="orange" tt="uppercase">☀️ Luz</Text>
                    ...
                    {plant.requirements.humidity && (
                        <Card withBorder radius="md">
                            <Text fw={700} size="xs" c="cyan" tt="uppercase">☁️ Humedad</Text>
                    ...
                    {plant.requirements.soil && (
                        <Card withBorder radius="md">
                            <Text fw={700} size="xs" c="brown" tt="uppercase">🪴 Suelo</Text>
                ...
                {plant.care?.last_watered && (
                    <Card withBorder padding="sm" radius="md" bg="gray.0">
                        <Text size="xs" fw={500} c="dimmed">Último riego registrado:</Text>
                        <Text size="sm" fw={700}>{plant.care.last_watered}</Text>
                    </Card>
                )}
            </Stack>
        </Container>
